...
public enum BlockTemplate {
        ...
        TABLE(new BlockType("table",
                        new Texture[] {
                                new Texture(ShapeList.CUBE, PathManager.loadImage("table/table02.png")),
                                new Texture(ShapeList.CUBE, PathManager.loadImage("table/table03.png")),
                                new Texture(ShapeList.CUBE, PathManager.loadImage("table/table04.png")),
                                new Texture(ShapeList.CUBE, PathManager.loadImage("table/table05.png")),
                                new Texture(ShapeList.CUBE, PathManager.loadImage("table/table06.png")),
                                new Texture(ShapeList.CUBE, PathManager.loadImage("table/table07.png")),
                                new Texture(ShapeList.CUBE, PathManager.loadImage("table/table08.png")),
                                new Texture(ShapeList.CUBE, PathManager.loadImage("table/table09.png")),
        ...
        BRIDGE(new BlockType("bridge",
                        new Texture[] {
                                new Texture(ShapeList.CUBE, PathManager.loadImage("bridge/bridge-left.png")),
                                new Texture(ShapeList.CUBE, PathManager.loadImage("bridge/bridge-right.png")),
                                },
