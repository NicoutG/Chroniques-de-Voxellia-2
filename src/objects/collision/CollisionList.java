...
public final class CollisionList {
    ...
    public static final ComplexCollision STAIR_ANGLE5 = new ComplexCollision(new BoundingCollision(-0.5, 0.5, -0.5, 0.5, 0.17, 0.5), new BoundingCollision(-0.5, 0.17, -0.5, 0.17, -0.17, 0.17), new BoundingCollision(-0.5, -0.17, -0.5, -0.17, -0.5, -0.17));
    public static final ComplexCollision STAIR_ANGLE6 = new ComplexCollision(new BoundingCollision(-0.5, 0.5, -0.5, 0.5, 0.17, 0.5), new BoundingCollision(-0.17, 0.5, -0.5, 0.17, -0.17, 0.17), new BoundingCollision(0.17, 0.5, -0.5, -0.17, -0.5, -0.17));
    public static final ComplexCollision STAIR_ANGLE7 = new ComplexCollision(new BoundingCollision(-0.5, 0.5, -0.5, 0.5, 0.17, 0.5), new BoundingCollision(-0.17, 0.5, -0.17, 0.5, -0.17, 0.17), new BoundingCollision(0.17, 0.5, 0.17, 0.5, -0.5, -0.17));
    public static final ComplexCollision STAIR_ANGLE8 = new ComplexCollision(new BoundingCollision(-0.5, 0.5, -0.5, 0.5, 0.17, 0.5), new BoundingCollision(-0.5, 0.17, -0.17, 0.5, -0.17, 0.17), new BoundingCollision(-0.5, -0.17, 0.17, 0.5, -0.5, -0.17));
