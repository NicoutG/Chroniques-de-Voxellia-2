...
public enum BlockTemplate {
        ...
        ACACIA_HOLDER(new BlockType("acaciaHolder",
                        new Texture[] { new Texture(ShapeList.HOLDER,
                                        PathManager.loadImage("woodBarriers/acacia-holder.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        ...
        ACACIA_BARRIER1(new BlockType("acaciaBarrier",
                        new Texture[] { new Texture(ShapeList.BARRIER1,
                                        PathManager.loadImage("woodBarriers/acacia-barrier1.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        ACACIA_BARRIER2(new BlockType("acaciaBarrier2",
                        new Texture[] { new Texture(ShapeList.BARRIER2,
                                        PathManager.loadImage("woodBarriers/acacia-barrier2.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        ACACIA_BARRIER3(new BlockType("acaciaBarrier3",
                        new Texture[] { new Texture(ShapeList.BARRIER3,
                                        PathManager.loadImage("woodBarriers/acacia-barrier3.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        OAK_HOLDER(new BlockType("oakHolder",
                        new Texture[] { new Texture(ShapeList.HOLDER,
                                        PathManager.loadImage("woodBarriers/oak-holder.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        OAK_BARRIER1(new BlockType("oakBarrier",
                        new Texture[] { new Texture(ShapeList.BARRIER1,
                                        PathManager.loadImage("woodBarriers/oak-barrier1.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        ...
        OAK_BARRIER2(new BlockType("oakBarrier2",
                        new Texture[] { new Texture(ShapeList.BARRIER2,
                                        PathManager.loadImage("woodBarriers/oak-barrier2.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        OAK_BARRIER3(new BlockType("oakBarrier3",
                        new Texture[] { new Texture(ShapeList.BARRIER3,
                                        PathManager.loadImage("woodBarriers/oak-barrier3.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        PINE_HOLDER(new BlockType("pineHolder",
                        new Texture[] { new Texture(ShapeList.HOLDER,
                                        PathManager.loadImage("woodBarriers/pine-holder.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        PINE_BARRIER1(new BlockType("pineBarrier",
                        new Texture[] { new Texture(ShapeList.BARRIER1,
                                        PathManager.loadImage("woodBarriers/pine-barrier1.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        PINE_BARRIER2(new BlockType("pineBarrier2",
                        new Texture[] { new Texture(ShapeList.BARRIER2,
                                        PathManager.loadImage("woodBarriers/pine-barrier2.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        ...
        PINE_BARRIER3(new BlockType("pineBarrier3",
                        new Texture[] { new Texture(ShapeList.BARRIER3,
                                        PathManager.loadImage("woodBarriers/pine-barrier3.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        WHITE_HOLDER(new BlockType("whiteHolder",
                        new Texture[] { new Texture(ShapeList.HOLDER,
                                        PathManager.loadImage("woodBarriers/white-holder.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        WHITE_BARRIER1(new BlockType("whiteBarrier",
                        new Texture[] { new Texture(ShapeList.BARRIER1,
                                        PathManager.loadImage("woodBarriers/white-barrier1.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        WHITE_BARRIER2(new BlockType("whiteBarrier2",
                        new Texture[] { new Texture(ShapeList.BARRIER2,
                                        PathManager.loadImage("woodBarriers/white-barrier2.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        WHITE_BARRIER3(new BlockType("whiteBarrier3",
                        new Texture[] { new Texture(ShapeList.BARRIER3,
                                        PathManager.loadImage("woodBarriers/white-barrier3.png")) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
