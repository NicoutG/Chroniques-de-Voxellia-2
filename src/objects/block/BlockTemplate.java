...
public enum BlockTemplate {
        ...
        BLUE_STAIRS_RIGHT(new BlockType("blueStairsRight",
                        new Texture[] { new Texture(ShapeList.STAIR2, PathManager.loadImage("blue-stairs-right.png"), false) },
        ...
        GLASS(new BlockType("glassBlock", 
                new Texture[] { Texture.createBasicTexture("glass-block.png", false)},
                null) {
                {
                        setOpacity(0.2);
                }
        ...
        LEVER(new BlockType("lever",
                        new Texture[] { new Texture(ShapeList.LEVER_OFF, PathManager.loadImage("lever/lever-F.png"), false),
                                        new Texture(ShapeList.LEVER_ON, PathManager.loadImage("lever/lever-T.png"), false) },
                        0,
                        null,
                        new Property[] { new Property(PropertyList.NO_COLLISION) },
                        new BlockBehavior[] {
        ...
        /* 20 */
        PINE_LOG(new BlockType("pineLog", "wood/pine-log.png")),
        ...
        HALF_HORIZONTAL1(new BlockType("blockHalfHorizontal1",
                        new Texture[] { new Texture(ShapeList.SLAB_BOTTOM,
                                        PathManager.loadImage("block-half-horizontal-1.png"), false) },
                        0,
        ...
        HALF_HORIZONTAL2(new BlockType("blockHalfHorizontal2",
                        new Texture[] { new Texture(ShapeList.SLAB_TOP,
                                        PathManager.loadImage("block-half-horizontal-2.png"), false) },
                        0,
        ...
        HALF_VERTICAL1(new BlockType("blockHalfVertical1",
                        new Texture[] { new Texture(ShapeList.SLAB_VERTICAL1,
                                        PathManager.loadImage("block-half-vertical-1.png"), false) },
        ...
        HALF_VERTICAL2(new BlockType("blockHalfVertical2",
                        new Texture[] { new Texture(ShapeList.SLAB_VERTICAL2,
                                        PathManager.loadImage("block-half-vertical-2.png"), false) },
        ...
        HALF_VERTICAL3(new BlockType("blockHalfVertical3",
                        new Texture[] { new Texture(ShapeList.SLAB_VERTICAL3,
                                        PathManager.loadImage("block-half-vertical-3.png"), false) },
        ...
        HALF_VERTICAL4(new BlockType("blockHalfVertical4",
                        new Texture[] { new Texture(ShapeList.SLAB_VERTICAL4,
                                        PathManager.loadImage("block-half-vertical-4.png"), false) },
        ...
        SLOPE_HALF1(new BlockType("blockSlopeHalf1",
                        new Texture[] { new Texture(ShapeList.SLOPE_HALF1,
                                        PathManager.loadImage("blockSlopes/block-slope-half1.png"), false) },
                        0.5,
        ...
        SLOPE_HALF2(new BlockType("blockSlopeHalf2",
                        new Texture[] { new Texture(ShapeList.SLOPE_HALF2,
                                        PathManager.loadImage("blockSlopes/block-slope-half2.png"), false) },
                        0.5,
        ...
        SLOPE_HALF3(new BlockType("blockSlopeHalf3",
                        new Texture[] { new Texture(ShapeList.SLOPE_HALF3,
                                        PathManager.loadImage("blockSlopes/block-slope-half3.png"), false) },
                        0.5,
        ...
        SLOPE_HALF4(new BlockType("blockSlopeHalf4",
                        new Texture[] { new Texture(ShapeList.SLOPE_HALF4,
                                        PathManager.loadImage("blockSlopes/block-slope-half4.png"), false) },
                        0.5,
        ...
        STAIRS_LEFT_MOSSY(new BlockType("blockStairsLeftMossy",
                        new Texture[] { new Texture(ShapeList.STAIR1,
                                        PathManager.loadImage("block-stairs-left-mossy.png"), false) },
                        0,
        ...
        STAIRS_RIGHT_MOSSY(new BlockType("blockStairsRightMossy",
                        new Texture[] { new Texture(ShapeList.STAIR2,
                                        PathManager.loadImage("block-stairs-right-mossy.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR2 },
                        null,
                        null)),
        STAIRS_LEFT(new BlockType("blockStairs1",
                        new Texture[] { new Texture(ShapeList.STAIR1,
                                        PathManager.loadImage("blockStairs/block-stairs1.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR1 },
                        null,
                        null)),
        ...
        STAIRS_RIGHT(new BlockType("blockStairs2",
                        new Texture[] { new Texture(ShapeList.STAIR2,
                                        PathManager.loadImage("blockStairs/block-stairs2.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR2 },
                        null,
                        null)),
        ...
        SHELVE(new BlockType("shelve", 
                        new Texture[] {Texture.createBasicTexture("shelve.png",false)},
                        null) {
                {
                        setOpacity(0);
                }
        ...
        WOOD_ACACIA(new BlockType("woodAcacia", "wood/wood-acacia.png")),
        WOOD_OAK(new BlockType("woodOak", "wood/wood-oak.png")),
        /* 95 */
        WOOD_PINE(new BlockType("woodPine", "wood/wood-pine.png")),
        ...
        STAINED_GLASS_RED_LEFT(new BlockType("stainedGlassRedLeft",
                        new Texture[] { new Texture(ShapeList.BORDER_LEFT,
                                        PathManager.loadImage("stained-glass/stained-glass-red-left.png"), false) },
                        0.1,
        ...
        STAINED_GLASS_RED_RIGHT(new BlockType("stainedGlassRedRight",
                        new Texture[] { new Texture(ShapeList.BORDER_RIGHT,
                                        PathManager.loadImage("stained-glass/stained-glass-red-right.png"), false) },
                        0.1,
        ...
        STAINED_GLASS_BLUE_LEFT(new BlockType("stainedGlassBlueLeft",
                        new Texture[] { new Texture(ShapeList.BORDER_LEFT,
                                        PathManager.loadImage("stained-glass/stained-glass-blue-left.png"), false) },
                        0.1,
                        new Collision[] { CollisionList.BARRIER_LEFT },
                        null,
                        null) {
        ...
        STAINED_GLASS_BLUE_RIGHT(new BlockType("stainedGlassBlueRight",
                        new Texture[] { new Texture(ShapeList.BORDER_RIGHT,
                                        PathManager.loadImage("stained-glass/stained-glass-blue-right.png"), false) },
                        0.1,
                        new Collision[] { CollisionList.BARRIER_RIGHT },
                        null,
                        null) {
                        ...
                        new Texture[] {
                                        new Texture(ShapeList.BORDER_LEFT,
                                                        PathManager.loadImage(
                                                                        "stained-glass/stained-glass-green-left.png"), false) },
                        0.1,
                        new Collision[] { CollisionList.BARRIER_LEFT },
                        null,
                        null) {
        ...
        STAINED_GLASS_GREEN_RIGHT(new BlockType("stainedGlassGreenRight",
                        new Texture[] {
                                        new Texture(ShapeList.BORDER_RIGHT,
                                                        PathManager.loadImage(
                                                                        "stained-glass/stained-glass-green-right.png"), false) },
                        0.1,
                        new Collision[] { CollisionList.BARRIER_RIGHT },
                        null,
                        null) {
        ...
        LINKED_LEVER(new BlockType("linkedLever",
                        new Texture[] { new Texture(ShapeList.LEVER_OFF,
                                        PathManager.loadImage("linkedLever/linked-lever-F.png"), false),
                                        new Texture(ShapeList.LEVER_ON,
                                                        PathManager.loadImage("linkedLever/linked-lever-T.png"), false) },
                        0,
                        null,
                        new Property[] { new Property(PropertyList.NO_COLLISION) },
        ...
        STAIRS3(new BlockType("blockStairs3",
                        new Texture[] { new Texture(ShapeList.STAIR3,
                                        PathManager.loadImage("blockStairs/block-stairs3.png"), false) },
                        0,
        ...
        STAIRS4(new BlockType("blockStairs4",
                        new Texture[] { new Texture(ShapeList.STAIR4,
                                        PathManager.loadImage("blockStairs/block-stairs4.png"), false) },
                        0,
        ...
        STAIRS_ANGLE1(new BlockType("blockStairsAngle1",
                        new Texture[] { new Texture(ShapeList.STAIR_ANGLE1,
                                        PathManager.loadImage("blockStairs/block-stairs-angle1.png"), false) },
                        0,
        ...
        STAIRS_ANGLE2(new BlockType("blockStairsAngle2",
                        new Texture[] { new Texture(ShapeList.STAIR_ANGLE2,
                                        PathManager.loadImage("blockStairs/block-stairs-angle2.png"), false) },
                        0,
        ...
        STAIRS_ANGLE3(new BlockType("blockStairsAngle3",
                        new Texture[] { new Texture(ShapeList.STAIR_ANGLE3,
                                        PathManager.loadImage("blockStairs/block-stairs-angle3.png"), false) },
                        0,
        ...
        STAIRS_ANGLE4(new BlockType("blockStairsAngle4",
                        new Texture[] { new Texture(ShapeList.STAIR_ANGLE4,
                                        PathManager.loadImage("blockStairs/block-stairs-angle4.png"), false) },
                        0,
        ...
        STAIRS_ANGLE5(new BlockType("blockStairsAngle5",
                        new Texture[] { new Texture(ShapeList.STAIR_ANGLE5,
                                        PathManager.loadImage("blockStairs/block-stairs-angle5.png"), false) },
                        0,
        ...
        STAIRS_ANGLE6(new BlockType("blockStairsAngle6",
                        new Texture[] { new Texture(ShapeList.STAIR_ANGLE6,
                                        PathManager.loadImage("blockStairs/block-stairs-angle6.png"), false) },
                        0,
        ...
        STAIRS_ANGLE7(new BlockType("blockStairsAngle7",
                        new Texture[] { new Texture(ShapeList.STAIR_ANGLE7,
                                        PathManager.loadImage("blockStairs/block-stairs-angle7.png"), false) },
                        0,
        ...
        STAIRS_ANGLE8(new BlockType("blockStairsAngle8",
                        new Texture[] { new Texture(ShapeList.STAIR_ANGLE8,
                                        PathManager.loadImage("blockStairs/block-stairs-angle8.png"), false) },
                        0,
        ...
        SIGN_LEFT(new BlockType("SignLeft",
                        new Texture[] { new Texture(ShapeList.SIGN_LEFT, PathManager.loadImage("sign-left.png"), false) },
                        0,
                        null,
                        null,
        ...
        SIGN_RIGHT(new BlockType("SignRight",
                        new Texture[] { new Texture(ShapeList.SIGN_RIGHT, PathManager.loadImage("sign-right.png"), false) },
                        0,
                        null,
                        null,
                        new BlockBehavior[] { new BlockBehaviorText() })),
        ...
        FLOWERS(new BlockType("flowers",
                        new Texture[] { new Texture(ShapeList.FLOWERS, PathManager.loadImage("herbs/flowers.png"), false) },
                        0,
                        null,
        ...
        GRASS_BIG(new BlockType("grassBig",
                        new Texture[] { new Texture(ShapeList.GRASS_BIG,
                                        PathManager.loadImage("herbs/grass-big.png"), false) },
                        0,
                        null,
                        new Property[] { new Property(PropertyList.NO_COLLISION), new Property("floor") },
                        null)),
        ...
        GRASS_SMALL(new BlockType("grassSmall",
                        new Texture[] { new Texture(ShapeList.GRASS_SMALL,
                                        PathManager.loadImage("herbs/grass-small.png"), false) },
                        0,
                        null,
                        new Property[] { new Property(PropertyList.NO_COLLISION), new Property("floor") },
                        null)),
        ...
        SLOPE1(new BlockType("blockSlope1",
                        new Texture[] { new Texture(ShapeList.SLOPE1,
                                        PathManager.loadImage("blockSlopes/block-slope1.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR1 },
                        null,
                        null)),
        SLOPE2(new BlockType("blockSlope2",
                        new Texture[] { new Texture(ShapeList.SLOPE2,
                                        PathManager.loadImage("blockSlopes/block-slope2.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR2 },
                        null,
                        null)),
        ...
        SLOPE3(new BlockType("blockSlope3",
                        new Texture[] { new Texture(ShapeList.SLOPE3,
                                        PathManager.loadImage("blockSlopes/block-slope3.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR3 },
                        null,
                        null)),
        SLOPE4(new BlockType("blockSlope4",
                        new Texture[] { new Texture(ShapeList.SLOPE4,
                                        PathManager.loadImage("blockSlopes/block-slope4.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR4 },
                        null,
                        null)),
        SLOPE5(new BlockType("blockSlope5",
                        new Texture[] { new Texture(ShapeList.SLOPE5,
                                        PathManager.loadImage("blockSlopes/block-slope5.png"), false) },
                        0.5,
        ...
        SLOPE6(new BlockType("blockSlope6",
                        new Texture[] { new Texture(ShapeList.SLOPE6,
                                        PathManager.loadImage("blockSlopes/block-slope6.png"), false) },
                        0.5,
        ...
        SLOPE7(new BlockType("blockSlope7",
                        new Texture[] { new Texture(ShapeList.SLOPE7,
                                        PathManager.loadImage("blockSlopes/block-slope7.png"), false) },
                        0.5,
        ...
        SLOPE8(new BlockType("blockSlope8",
                        new Texture[] { new Texture(ShapeList.SLOPE8,
                                        PathManager.loadImage("blockSlopes/block-slope8.png"), false) },
                        0.5,
        ...
        SLOPE_ANGLE1(new BlockType("blockSlopeAngle1",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE1,
                                        PathManager.loadImage("blockSlopes/block-slope-angle1.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE1 },
                        null,
                        null)),
        SLOPE_ANGLE2(new BlockType("blockSlopeAngle2",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE2,
                                        PathManager.loadImage("blockSlopes/block-slope-angle2.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE2 },
                        null,
                        null)),
        SLOPE_ANGLE3(new BlockType("blockSlopeAngle3",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE3,
                                        PathManager.loadImage("blockSlopes/block-slope-angle3.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE3 },
                        null,
                        null)),
        SLOPE_ANGLE4(new BlockType("blockSlopeAngle4",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE4,
                                        PathManager.loadImage("blockSlopes/block-slope-angle4.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE4 },
                        null,
                        null)),
        ...
        SLOPE_ANGLE6(new BlockType("blockSlopeAngle6",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE6,
                                        PathManager.loadImage("blockSlopes/block-slope-angle6.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE6 },
                        null,
                        null)),
        SLOPE_ANGLE7(new BlockType("blockSlopeAngle7",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE7,
                                        PathManager.loadImage("blockSlopes/block-slope-angle7.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE7 },
                        null,
                        null)),
        SLOPE_ANGLE8(new BlockType("blockSlopeAngle8",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE8,
                                        PathManager.loadImage("blockSlopes/block-slope-angle8.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE8 },
                        null,
                        null)),
        ROOF_TILES_RED1(new BlockType("roofTilesRed1",
                        new Texture[] { new Texture(ShapeList.SLOPE1,
                                        PathManager.loadImage("roofTilesRed/roof-tiles-red1.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR1 },
                        null,
                        null)),
        ...
        ROOF_TILES_RED2(new BlockType("roofTilesRed2",
                        new Texture[] { new Texture(ShapeList.SLOPE2,
                                        PathManager.loadImage("roofTilesRed/roof-tiles-red2.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR2 },
                        null,
                        null)),
        ROOF_TILES_RED_ANGLE1(new BlockType("roofTilesRedAngle1",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE1,
                                        PathManager.loadImage("roofTilesRed/roof-tiles-red-angle1.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE1 },
                        null,
                        null)),
        ROOF_TILES_RED_ANGLE2(new BlockType("roofTilesRedAngle2",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE2,
                                        PathManager.loadImage("roofTilesRed/roof-tiles-red-angle2.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE2 },
                        null,
                        null)),
        ROOF_TILES_RED_ANGLE4(new BlockType("roofTilesRedAngle4",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE4,
                                        PathManager.loadImage("roofTilesRed/roof-tiles-red-angle4.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE4 },
                        null,
                        null)),
        ...
        ROOF_TILES_RED_ANGLE6(new BlockType("roofTilesRedAngle6",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE6,
                                        PathManager.loadImage("roofTilesRed/roof-tiles-red-angle6.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE6 },
                        null,
                        null)),
        ROOF_TILES_RED_ANGLE8(new BlockType("roofTilesRedAngle8",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE8,
                                        PathManager.loadImage("roofTilesRed/roof-tiles-red-angle8.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE8 },
                        null,
                        null)),
        ROOF_TILES_RED_WOOD_ANGLE1(new BlockType("roofTilesRedWoodAngle1",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE1,
                                        PathManager.loadImage("roofTilesRed/roof-tiles-red-wood-angle1.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE1 },
                        null,
                        null)),
        ROOF_TILES_RED_WOOD_ANGLE2(new BlockType("roofTilesRedWoodAngle2",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE2,
                                        PathManager.loadImage("roofTilesRed/roof-tiles-red-wood-angle2.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE2 },
                        null,
                        null)),
        ROOF_TILES_RED_WOOD_ANGLE4(new BlockType("roofTilesRedWoodAngle4",
                        new Texture[] { new Texture(ShapeList.SLOPE_ANGLE4,
                                        PathManager.loadImage("roofTilesRed/roof-tiles-red-wood-angle4.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.STAIR_ANGLE4 },
                        null,
                        null)),
        ...
        STONE_BARRIER_LEFT(new BlockType("stoneBarrierLeft",
                        new Texture[] { new Texture(ShapeList.BORDER_LEFT,
                                        PathManager.loadImage("stoneBarriers/stone-barrier-left.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.BARRIER_LEFT },
                        null,
                        null)),
        ...
        STONE_BARRIER_RIGHT(new BlockType("stoneBarrierRight",
                        new Texture[] { new Texture(ShapeList.BORDER_RIGHT,
                                        PathManager.loadImage("stoneBarriers/stone-barrier-right.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.BARRIER_RIGHT },
                        null,
                        null)),
        STONE_BARRIER_ANGLE1(new BlockType("stoneBarrierAngle1",
                        new Texture[] { new Texture(ShapeList.BORDER_ANGLE1,
                                        PathManager.loadImage("stoneBarriers/stone-barrier-angle1.png"), false) },
                        0.5,
        ...
        STONE_BARRIER_ANGLE2(new BlockType("stoneBarrierAngle2",
                        new Texture[] { new Texture(ShapeList.BORDER_ANGLE2,
                                        PathManager.loadImage("stoneBarriers/stone-barrier-angle2.png"), false) },
                        0.5,
        ...
        STONE_BARRIER_ANGLE3(new BlockType("stoneBarrierAngle3",
                        new Texture[] { new Texture(ShapeList.BORDER_ANGLE3,
                                        PathManager.loadImage("stoneBarriers/stone-barrier-angle3.png"), false) },
                        0.5,
        ...
        STONE_BARRIER_ANGLE4(new BlockType("stoneBarrierAngle4",
                        new Texture[] { new Texture(ShapeList.BORDER_ANGLE4,
                                        PathManager.loadImage("stoneBarriers/stone-barrier-angle4.png"), false) },
                        0.5,
        ...
        HOLDER(new BlockType("holder",
                        new Texture[] { new Texture(ShapeList.HOLDER,
                                        PathManager.loadImage("holders/holder.png"), false) },
                        0.2,
        ...
        HOLDER_ROPE1(new BlockType("holderRope1",
                        new Texture[] { new Texture(ShapeList.HOLDER_ROPE1,
                                        PathManager.loadImage("holders/holder-rope1.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        HOLDER_ROPE2(new BlockType("holderRope2",
                        new Texture[] { new Texture(ShapeList.HOLDER_ROPE2,
                                        PathManager.loadImage("holders/holder-rope2.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        HOLDER_ROPE3(new BlockType("holderRope3",
                        new Texture[] { new Texture(ShapeList.HOLDER_ROPE3,
                                        PathManager.loadImage("holders/holder-rope3.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        ACACIA_HOLDER(new BlockType("acaciaHolder",
                        new Texture[] { new Texture(ShapeList.HOLDER,
                                        PathManager.loadImage("wood/woodBarriers/acacia-holder.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        ...
        ACACIA_BARRIER1(new BlockType("acaciaBarrier",
                        new Texture[] { new Texture(ShapeList.BARRIER1,
                                        PathManager.loadImage("wood/woodBarriers/acacia-barrier1.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        ACACIA_BARRIER2(new BlockType("acaciaBarrier2",
                        new Texture[] { new Texture(ShapeList.BARRIER2,
                                        PathManager.loadImage("wood/woodBarriers/acacia-barrier2.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        ACACIA_BARRIER3(new BlockType("acaciaBarrier3",
                        new Texture[] { new Texture(ShapeList.BARRIER3,
                                        PathManager.loadImage("wood/woodBarriers/acacia-barrier3.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        OAK_HOLDER(new BlockType("oakHolder",
                        new Texture[] { new Texture(ShapeList.HOLDER,
                                        PathManager.loadImage("wood/woodBarriers/oak-holder.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        OAK_BARRIER1(new BlockType("oakBarrier",
                        new Texture[] { new Texture(ShapeList.BARRIER1,
                                        PathManager.loadImage("wood/woodBarriers/oak-barrier1.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        ...
        OAK_BARRIER2(new BlockType("oakBarrier2",
                        new Texture[] { new Texture(ShapeList.BARRIER2,
                                        PathManager.loadImage("wood/woodBarriers/oak-barrier2.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        OAK_BARRIER3(new BlockType("oakBarrier3",
                        new Texture[] { new Texture(ShapeList.BARRIER3,
                                        PathManager.loadImage("wood/woodBarriers/oak-barrier3.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        PINE_HOLDER(new BlockType("pineHolder",
                        new Texture[] { new Texture(ShapeList.HOLDER,
                                        PathManager.loadImage("wood/woodBarriers/pine-holder.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        PINE_BARRIER1(new BlockType("pineBarrier",
                        new Texture[] { new Texture(ShapeList.BARRIER1,
                                        PathManager.loadImage("wood/woodBarriers/pine-barrier1.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        PINE_BARRIER2(new BlockType("pineBarrier2",
                        new Texture[] { new Texture(ShapeList.BARRIER2,
                                        PathManager.loadImage("wood/woodBarriers/pine-barrier2.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        ...
        PINE_BARRIER3(new BlockType("pineBarrier3",
                        new Texture[] { new Texture(ShapeList.BARRIER3,
                                        PathManager.loadImage("wood/woodBarriers/pine-barrier3.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        WHITE_HOLDER(new BlockType("whiteHolder",
                        new Texture[] { new Texture(ShapeList.HOLDER,
                                        PathManager.loadImage("wood/woodBarriers/white-holder.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        WHITE_BARRIER1(new BlockType("whiteBarrier",
                        new Texture[] { new Texture(ShapeList.BARRIER1,
                                        PathManager.loadImage("wood/woodBarriers/white-barrier1.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        WHITE_BARRIER2(new BlockType("whiteBarrier2",
                        new Texture[] { new Texture(ShapeList.BARRIER2,
                                        PathManager.loadImage("wood/woodBarriers/white-barrier2.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        WHITE_BARRIER3(new BlockType("whiteBarrier3",
                        new Texture[] { new Texture(ShapeList.BARRIER3,
                                        PathManager.loadImage("wood/woodBarriers/white-barrier3.png"), false) },
                        0.2,
                        new Collision[] { CollisionList.POLE },
                        null,
                        null)),
        /* 190 */
        WOOD_WHITE(new BlockType("woodWhite", "wood/wood-white.png")),
        WIND(new BlockType("wind",
                        new Texture[] {},
                        new Property[] { new Property(PropertyList.NO_COLLISION) },
                        new BlockBehavior[] {
                                        new BlockBehaviorApplyForce(1,0,0) })),
        BLOCK_BRICKS(new BlockType("blockBricks", "block-bricks.png")),
        YELLOW_BRICKS(new BlockType("yellowBricks", "yellow-bricks.png")),
        ACACIA_LOG(new BlockType("acaciaLog", "wood/acacia-log.png")),
        /* 195 */
        OAK_LOG(new BlockType("oakLog", "wood/oak-log.png")),
        WHITE_LOG(new BlockType("whiteLog", "wood/white-log.png")),
        ACACIA_STAIRS_LEFT(new BlockType("acaciaStairs1",
                        new Texture[] { new Texture(ShapeList.STAIR1,
                                        PathManager.loadImage("wood/woodStairs/wood-acacia-stairs1.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR1 },
                        null,
                        null)),
        ACACIA_STAIRS_RIGHT(new BlockType("acaciaStairs2",
                        new Texture[] { new Texture(ShapeList.STAIR2,
                                        PathManager.loadImage("wood/woodStairs/wood-acacia-stairs2.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR2 },
                        null,
                        null)),
        OAK_STAIRS_LEFT(new BlockType("oakStairs1",
                        new Texture[] { new Texture(ShapeList.STAIR1,
                                        PathManager.loadImage("wood/woodStairs/wood-oak-stairs1.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR1 },
                        null,
                        null)),
        ...
        OAK_STAIRS_RIGHT(new BlockType("oakStairs2",
                        new Texture[] { new Texture(ShapeList.STAIR2,
                                        PathManager.loadImage("wood/woodStairs/wood-oak-stairs2.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR2 },
                        null,
                        null)),
        PINE_STAIRS_LEFT(new BlockType("pineStairs1",
                        new Texture[] { new Texture(ShapeList.STAIR1,
                                        PathManager.loadImage("wood/woodStairs/wood-pine-stairs1.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR1 },
                        null,
                        null)),
        PINE_STAIRS_RIGHT(new BlockType("pineStairs2",
                        new Texture[] { new Texture(ShapeList.STAIR2,
                                        PathManager.loadImage("wood/woodStairs/wood-pine-stairs2.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR2 },
                        null,
                        null)),
        WHITE_STAIRS_LEFT(new BlockType("whiteStairs1",
                        new Texture[] { new Texture(ShapeList.STAIR1,
                                        PathManager.loadImage("wood/woodStairs/wood-white-stairs1.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR1 },
                        null,
                        null)),
        WHITE_STAIRS_RIGHT(new BlockType("whiteStairs2",
                        new Texture[] { new Texture(ShapeList.STAIR2,
                                        PathManager.loadImage("wood/woodStairs/wood-white-stairs2.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR2 },
                        null,
                        null)),
        ...
        COLUMN(new BlockType("column",
                        new Texture[] { new Texture(ShapeList.COLUMN,
                                        PathManager.loadImage("column.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.COLUMN },
                        null,
                        null)),
        WHITE_COLUMN(new BlockType("whiteColumn",
                        new Texture[] { new Texture(ShapeList.COLUMN,
                                        PathManager.loadImage("white-column.png"), false) },
                        0.5,
                        new Collision[] { CollisionList.COLUMN },
                        null,
                        null)),
        FRAME_LEFT(new BlockType("frameLeft",
                        new Texture[] { new Texture(ShapeList.INSIDE,
                                        PathManager.loadImage("frame-left.png"), false) },
                        0,
                        null,
                        new Property[] {new Property(PropertyList.NO_COLLISION), new Property("floor")},
                        new BlockBehavior[] { new BlockBehaviorText() })),
        FRAME_RIGHT(new BlockType("frameRight",
                        new Texture[] { new Texture(ShapeList.INSIDE,
                                        PathManager.loadImage("frame-right.png"), false) },
                        0,
                        null,
                        new Property[] {new Property(PropertyList.NO_COLLISION), new Property("floor")},
                        new BlockBehavior[] { new BlockBehaviorText() })),
        LIAN_LEFT(new BlockType("lianLeft",
                        new Texture[] { new Texture(ShapeList.INSIDE,
                                        PathManager.loadImage("lian-left.png"), false) },
                        0,
                        null,
        ...
        LIAN_RIGHT(new BlockType("lianRight",
                        new Texture[] { new Texture(ShapeList.INSIDE,
                                        PathManager.loadImage("lian-right.png"), false) },
                        0,
                        null,
                        new Property[] {new Property(PropertyList.NO_COLLISION), new Property(PropertyList.BURNABLE)},
                        null)),
        ACACIA_STAIRS_3(new BlockType("acaciaStairs3",
                        new Texture[] { new Texture(ShapeList.STAIR3,
                                        PathManager.loadImage("wood/woodStairs/wood-acacia-stairs3.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR3 },
                        null,
                        null)),
        ACACIA_STAIRS_4(new BlockType("acaciaStairs4",
                        new Texture[] { new Texture(ShapeList.STAIR4,
                                        PathManager.loadImage("wood/woodStairs/wood-acacia-stairs4.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR4 },
                        null,
                        null)),
        OAK_STAIRS_3(new BlockType("oakStairs3",
                        new Texture[] { new Texture(ShapeList.STAIR3,
                                        PathManager.loadImage("wood/woodStairs/wood-oak-stairs3.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR3 },
                        null,
                        null)),
        OAK_STAIRS_4(new BlockType("oakStairs4",
                        new Texture[] { new Texture(ShapeList.STAIR4,
                                        PathManager.loadImage("wood/woodStairs/wood-oak-stairs4.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR4 },
                        null,
                        null)),
        ...
        PINE_STAIRS_3(new BlockType("pineStairs3",
                        new Texture[] { new Texture(ShapeList.STAIR3,
                                        PathManager.loadImage("wood/woodStairs/wood-pine-stairs3.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR3 },
                        null,
                        null)),
        PINE_STAIRS_4(new BlockType("pineStairs4",
                        new Texture[] { new Texture(ShapeList.STAIR4,
                                        PathManager.loadImage("wood/woodStairs/wood-pine-stairs4.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR4 },
                        null,
                        null)),
        WHITE_STAIRS_3(new BlockType("whiteStairs3",
                        new Texture[] { new Texture(ShapeList.STAIR3,
                                        PathManager.loadImage("wood/woodStairs/wood-white-stairs3.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR3 },
                        null,
                        null)),
        WHITE_STAIRS_4(new BlockType("whiteStairs4",
                        new Texture[] { new Texture(ShapeList.STAIR4,
                                        PathManager.loadImage("wood/woodStairs/wood-white-stairs4.png"), false) },
                        0,
                        new Collision[] { CollisionList.STAIR4 },
                        null,
                        null)),
        GRID_LEFT(new BlockType("gridLeft",
                        new Texture[] { new Texture(ShapeList.BORDER_LEFT,
                                        PathManager.loadImage("grids/grid-left.png"), false) },
                        0,
                        new Collision[] { CollisionList.BARRIER_LEFT },
                        null,
                        null)),
        ...
        GRID_RIGHT(new BlockType("gridRight",
                        new Texture[] { new Texture(ShapeList.BORDER_RIGHT,
                                        PathManager.loadImage("grids/grid-right.png"), false) },
                        0,
                        new Collision[] { CollisionList.BARRIER_RIGHT },
                        null,
                        null)),
        GRID_HORIZONTAL(new BlockType("gridHorizontal",
                        new Texture[] { new Texture(ShapeList.BORDER_HORIZONTAL,
                                        PathManager.loadImage("grids/grid-horizontal.png"), false) },
                        0,
